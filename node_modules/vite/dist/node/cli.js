...
var build = require('./chunks/dep-994e0558.js');
var os = require('os');
...
cli
    ...
    // is ok here
    const { createServer } = await Promise.resolve().then(function () { return require('./chunks/dep-994e0558.js'); }).then(function (n) { return n.index$1; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    const { build: build$1 } = await Promise.resolve().then(function () { return require('./chunks/dep-994e0558.js'); }).then(function (n) { return n.build$1; });
...
cli
    ...
    .option('--force', `[boolean] force the optimizer to ignore the cache and re-bundle`)
    .action(async (root, options) => {
    const { optimizeDeps } = await Promise.resolve().then(function () { return require('./chunks/dep-994e0558.js'); }).then(function (n) { return n.index; });
    try {
