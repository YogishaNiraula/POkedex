...
var _utils = require('windicss/utils');
var _fastglob = require('fast-glob'); var _fastglob2 = _interopRequireDefault(_fastglob);
var _debug3 = require('debug'); var _debug4 = _interopRequireDefault(_debug3);
...
async function loadConfiguration(options) {
  ...
  if (typeof config === "string" || !config) {
    if (!config) {
      ...
      configFilePath = _path.resolve.call(void 0, root, config);
    ...
    if (configFilePath) {
      ...
      try {
        ...
        const isEsmJS = configFilePath.endsWith(".js") && (await _fs.promises.readFile(configFilePath, "utf-8")).includes("export default ");
        if (enableSucrase)
...
function createUtils(userOptions = {}, utilsOptions = {
  ...
  const debug = {
    config: _debug4.default.call(void 0, `${name}:config`),
    debug: _debug4.default.call(void 0, `${name}:debug`),
  ...
  function getCompletions() {
    if (!completions)
      completions = _utils.generateCompletions.call(void 0, processor);
    return completions;
  }
  ...
  function isExcluded(id) {
    return _micromatch2.default.isMatch(slash(id), options.scanOptions.exclude, {dot: true});
  }
...
exports.DefaultExtractor = DefaultExtractor; exports.PugExtractor = PugExtractor; exports.SupportedLayers = SupportedLayers; exports.applyExtractors = applyExtractors; exports.createUtils = createUtils; exports.defaultAlias = defaultAlias; exports.defaultConfigureFiles = defaultConfigureFiles; exports.defineConfig = defineConfig; exports.exclude = exclude; exports.flattenArray = flattenArray; exports.getDefaultExtractors = getDefaultExtractors; exports.htmlTags = htmlTags; exports.include = include; exports.isResolvedOptions = isResolvedOptions; exports.kebabCase = kebabCase; exports.loadConfiguration = loadConfiguration; exports.mergeArrays = mergeArrays; exports.mergeWindicssConfig = mergeWindicssConfig; exports.partition = partition; exports.preflightTags = preflightTags; exports.resolveOptions = resolveOptions; exports.slash = slash; exports.toArray = toArray; exports.transformGroups = transformGroups; exports.transformGroupsWithSourcemap = transformGroupsWithSourcemap;
