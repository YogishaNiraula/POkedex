"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; } function _createStarExport(obj) { Object.keys(obj) .filter((key) => key !== "default" && key !== "__esModule") .forEach((key) => { if (exports.hasOwnProperty(key)) { return; } Object.defineProperty(exports, key, {enumerable: true, get: () => obj[key]}); }); }var __defProp = Object.defineProperty;
...
var _pluginutils = require('@windicss/plugin-utils'); _createStarExport(_pluginutils);
...
// src/devtools.ts
var debug = {
  devtools: _debug4.default.call(void 0, `${NAME}:devtools`)
};
  ...
  return [
    {
      ...
      async load(id) {
        if (id === DEVTOOLS_PATH) {
          if (!clientCode) {
            clientCode = [
              await _fs.promises.readFile(_path.resolve.call(void 0, __dirname, "client.mjs"), "utf-8"),
...
var debug2 = {
  hmr: _debug4.default.call(void 0, `${NAME}:hmr`),
  css: _debug4.default.call(void 0, `${NAME}:transform:css`),
  group: _debug4.default.call(void 0, `${NAME}:transform:group`),
  memory: _debug4.default.call(void 0, `${NAME}:memory`)
};
function VitePluginWindicss(userOptions = {}, utilsOptions = {}) {
  ...
  plugins.push(__objSpread({
    ...
    async configResolved(_config) {
      viteConfig = _config;
      utils = _pluginutils.createUtils.call(void 0, userOptions, __objSpread({
        name: NAME,
        root: _config.root,
  ...
  plugins.push({
    ...
    async handleHotUpdate({server: server2, file, read, modules}) {
      if (_path.resolve.call(void 0, file) === utils.configFilePath) {
        debug2.hmr(`config file changed: ${file}`);
        await utils.init();
        setTimeout(() => {
          _debug3.log.call(void 0, "configure file changed, reloading");
